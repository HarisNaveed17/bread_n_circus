...
2. Resolve relative dates ("this Saturday", "tomorrow", "next week") against the post date you are given. A date with no year takes the year that makes it fall on or after the post date.
3. If the text gives both a weekday and a date, they are a cross-check. When they disagree, trust the explicit date and lower nothing else.
